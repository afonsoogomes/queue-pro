    ...
    <form action="" method="get">
        ...
        <div class="flex items-center my-2 -mx-2">
            ...
            <div class="px-2 w-1/4">
                <label for="filter_name" class="block mb-1 text-xs font-light text-white">
                    @lang('Job name')
                </label>
                <input
                    type="text"
                    ...
                    class="w-full px-3 py-2 bg-gray-50 dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded text-sm text-white"
                >
            </div>

            @if(config('queue-monitor.ui.show_custom_data'))
                <div class="px-2 w-1/4">
                    <label for="filter_custom_data" class="block mb-1 text-xs font-light text-white">
                        @lang('Custom Data')
                    </label>
                    <input
                        type="text"
            ...
            <div class="px-2 w-1/4">
                <label for="filter_status" class="block mb-1 text-xs font-light text-white">
                    @lang('Status')
                </label>
                <select
                    name="status"
            ...
            <div class="px-2 w-1/4">
                <label for="filter_queues"
                       class="block mb-1 text-xs font-light text-white">
                    @lang('Queues')
                </label>
                <select name="queue"
                        id="filter_queues"
